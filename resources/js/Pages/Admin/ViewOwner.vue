        ...
        <div class="bg-white text-gray-900 dark:bg-gray-800 text-white ml-4 mr-4 md-2 rounded-lg">
            ...
            <div>
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <div class="flex items-center justify-between pb-4">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="table-search" v-model="search"
                                ...
                                placeholder="Search for Gym Owners">
                        </div>
                    </div>
                    <div class="mb-4">
                        <ul
                            ...
                            <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                                <div class="flex items-center pl-3">
                                    ...
                                    <label for="vue-checkbox-list"
                                        class="w-full py-3 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Blocked</label>
                                </div>
                            </li>
                            <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                                <div class="flex items-center pl-3">
                    ...
                    <pagination :links="GymOwners.links" />
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            <tr v-for="GymOwner in props.GymOwners.data" :key="GymOwner.id"
                                class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                <th scope="row"
                                    class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    User Id - {{ GymOwner.user.id }} <p v-if="GymOwner.id">Gym ID: {{ GymOwner.id }}</p>
                                    <p v-if="GymOwner.gym_name">Gym Name: {{ GymOwner.gym_name }}</p>
                                </th>
                                <th scope="row"
                                    class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    {{ GymOwner.user.name }}<br />{{ GymOwner.user.email }}
                                </th>
                                <td class="px-6 py-4">
                                    <p v-if="GymOwner.user.subscriptions && GymOwner.user.subscriptions.name">
                                        Subscription Name: {{ GymOwner.user.subscriptions.name }}
                                    </p>

                                </td>
                                <td class="px-6 py-4">
                                    <p v-if="GymOwner.user.status">Active</p>
                                    <p v-else>Inactive</p>
                                    <div>
                                        ...
                                        <button data-modal-target="popup-modal" data-modal-toggle="popup-modal"
                                            ...
                                            type="button">
                                            <div v-if="GymOwner.user.Suspend" ? 1>Suspend</div>
                                            <div v-if="GymOwner.user.Suspend" ? 0>Activate</div>
                                        </button>
                                                ...
                                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                    ...
                                                    <div class="p-6 text-center">
                                                        ...
                                                        <h3
                                                            ...
                                                            Are you sure you want to ban this user??</h3>
                                ...
                                <td class="px-6 py-4">
                                    <Link :href="route('gym-owner.edit', GymOwner.id)"
                                        class="font-medium text-green-600 dark:text-green-500 hover:underline">Edit</Link>
                                    <br />
                                    <Link :href="route('gym-owner.show', GymOwner.id)"
                                        class="font-medium text-blue-600 dark:text-blue-500 hover:underline">View</Link>
                                    <br />
                                    <Link :href="route('gym-owner.destroy', GymOwner.id)"
