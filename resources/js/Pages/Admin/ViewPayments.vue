...
let printInvoice = () => {
    ...
    router.get({
        name: 'GymOwnerPaymentBasicInvoice', // Replace with the correct route name asasa asas
        ...
        <div class="bg-white text-gray-900 dark:bg-gray-800 text-white ml-4 mr-4 md-2 rounded-lg">
            ...
            <div>
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    ...
                    <div class="flex items-center justify-between pb-4">
                        <pagination :links="GymOwnerPayments.links" />
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            <tr v-for="GymOwnerPayment in props.GymOwnerPayments.data" :key="GymOwnerPayment.id"
                                class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                <th scope="row"
                                    class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    Payment Id - {{ GymOwnerPayment.id }} <br>
                                    Payment Date- {{ GymOwnerPayment.created_at }}
                                </th>
                                <th scope="row"
                                    class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <p v-if="GymOwnerPayment.gym_owner.gym_name">
                                        {{ GymOwnerPayment.gym_owner.gym_name }}
                                    </p>
                                </th>
                                <th scope="row"
                                    class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    LKR{{ GymOwnerPayment.amount }}
                                </th>
                                <td class="px-6 py-4">
                                    {{ GymOwnerPayment.commission }}%
                                </td>
                                <td class="px-6 py-4">
                                    LKR {{ GymOwnerPayment.profit }}
                                </td>
                                <td class="px-6 py-4">
                                    {{ GymOwnerPayment.payment_type }}
                                </td>
                        ...
                        <button type="button"
                            ...
                            <a :href="route('GymOwnerPaymentBasicInvoice', {search: search.value, date_from: newDateFrom, date_to: newDateTo  })"
