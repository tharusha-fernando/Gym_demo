...
function submit() {
    form.post('/create-account/gym-trainer/store')
}
...
<template>
    ...
    <div class="mb-6 ml-2 mr-2 p-4">
        <h2 class="mb-4 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-4xl dark:text-white">Gym Trainer Account</h2>
        <hr/>
    </div>
            ...
            <div>
                ...
                <form class="mr-4 ml-4 md-4" @submit.prevent="submit">
                    ...
                    <div class="mb-6">
                        ...
                        <div v-if="form.errors.email" v-text="form.errors.email" class="text-red-500 text-xs mt-2 mr-2">
                        </div>
                    </div>
                    <div class="mb-6">
