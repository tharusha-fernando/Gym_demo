        ...
        <div class="bg-white text-gray-900 dark:bg-gray-800 text-white ml-4 mr-4 md-2 rounded-lg">
            ...
            <div>
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <div class="flex items-center justify-between pb-4">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="table-search" v-model="search"
                                ...
                                placeholder="Search for Gym Members">
                        </div>
                    </div>
                    <div class="mb-4">
                        <ul
                    ...
                    <pagination :links="GymMembers.links" />
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            <tr v-for="GymMember in props.GymMembers.data" :key="GymMember.id"
                                class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                <th scope="row"
                                    class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    User Id - {{ GymMember.user.id }} <p v-if="GymMember.id">Gym Member ID: {{ GymMember.id }}</p>
                                    
                                </th>
                                <th scope="row"
                                    class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    {{ GymMember.user.name }}<br />{{ GymMember.user.email }}
                                </th>
                                <td class="px-6 py-4">
                                    <p v-if=" GymMember.gym_subscription &&  GymMember.gym_subscription.name">
                                        Subscription : {{ GymMember.gym_subscription.name }}
                                    </p>

                                </td>
                                <td class="px-6 py-4">
                                    <p v-if="GymMember.user.status">Active</p>
                                    <p v-else>Inactive</p>
                                    <div>
                                        ...
                                        <button data-modal-target="popup-modal" data-modal-toggle="popup-modal"
                                            ...
                                            type="button">
                                            <div v-if="GymMember.user.Suspend" ? 1>Suspend</div>
                                            <div v-if="GymMember.user.Suspend" ? 0>Activate</div>
                                        </button>
