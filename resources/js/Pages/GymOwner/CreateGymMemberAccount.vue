...
function submit() {
    form.post('/create-account/gym-member/store')
}
...
<template>
    ...
    <div class="mb-6 ml-2 mr-2 p-4">
        <h2 class="mb-4 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-4xl dark:text-white">Gym Owner Account</h2>
        <hr/>
    </div>
