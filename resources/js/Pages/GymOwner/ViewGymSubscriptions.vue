        ...
        <div class="bg-white text-gray-900 dark:bg-gray-800 text-white ml-4 mr-4 md-2 rounded-lg">
            ...
            <div>
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    ...
                    <div class="m-2">
                        <Link :href="route('gym-subscriptions.create')"
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            <tr v-for="gym_subscription in props.GymSubscriptions.data" :key="gym_subscription.id"
                                class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                <th scope="row"
                                    class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    Gym Subscriptions Id - {{ gym_subscription.id }}
                                </th>
                                <th scope="row"
                                    class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    {{ gym_subscription.name }}
                                </th>
                                <th scope="row"
                                    class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    {{ gym_subscription.description}}
                                </th>
                                <td class="px-6 py-4">
                                    LKR {{ gym_subscription.price }}
                                </td>

                                <td class="px-6 py-4">
                                    <Link :href="route('gym-subscriptions.edit', { gym_subscription: gym_subscription.id })" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Update</Link>
