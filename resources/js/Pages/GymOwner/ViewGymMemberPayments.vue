        ...
        <div class="bg-white text-gray-900 dark:bg-gray-800 text-white ml-4 mr-4 md-2 rounded-lg">
            ...
            <div>
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    ...
                    <div class="flex items-center justify-between pb-4">
                        <pagination :links="GymMemberPayments.links" />
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            <tr v-for="GymMemberPayment in props.GymMemberPayments.data" :key="GymMemberPayment.id"
                                class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                <th scope="row"
                                    class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    Payment Id - {{ GymMemberPayment.id }} <br>
                                    Payment Date- {{ GymMemberPayment.created_at }}
                                </th>
                                <th scope="row"
                                    class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <p v-if="GymMemberPayment.gym_member.user.name">
                                        {{ GymMemberPayment.gym_member.user.name }}
                                    </p>
                                </th>
                                <th scope="row"
                                    class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    LKR{{ GymMemberPayment.amount }}
                                </th>
                                <td class="px-6 py-4">
                                    {{ GymMemberPayment.commission }}%
                                </td>
                                <td class="px-6 py-4">
                                    LKR {{ GymMemberPayment.profit }}
                                </td>
                                <td class="px-6 py-4">
                                    {{ GymMemberPayment.payment_type }}
                                </td>
